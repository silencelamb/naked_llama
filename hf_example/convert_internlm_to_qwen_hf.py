...
for name, param in internlm_model.named_parameters():
    if "model.layers." in name:
        ...
        qwen2_model.state_dict()[intern_llama_mapping[name]].copy_(param)
    else:
        print(f"Layer {name} not found in Qwen2ForCausalLM.")
...
qwen2_model.save_pretrained("internlm_converted_qwen2")

tokenizer = AutoTokenizer.from_pretrained("internlm/internlm2_5-7b-chat", trust_remote_code=True)
tokenizer.save_pretrained("internlm_converted_qwen2")
